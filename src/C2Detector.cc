...
//Rock
    ...
    RockLogical= new G4LogicalVolume(RockSolid,Rock,"RockLogical",0,0,0);
...
//
    NComponents= 7;
    Density= 2.5*g/cm3;
    Rock= new G4Material(Name="Rock",Density,NComponents);
    Rock->AddElement(elO ,FractionMass= 0.600); //1.
    Rock->AddElement(elNa,FractionMass= 0.020); //2.
    Rock->AddElement(elMg,FractionMass= 0.025); //3.
    Rock->AddElement(elAl,FractionMass= 0.060); //4.
    Rock->AddElement(elSi,FractionMass= 0.175); //5.
    Rock->AddElement(elCa,FractionMass= 0.050); //6.
    Rock->AddElement(elFe,FractionMass= 0.070); //7.
//Concrete
    NComponents= 6;
    Density= 2.5*g/cm3;
    Concrete= new G4Material(Name="Rock",Density,NComponents);
...
//
    ...
    A      = 39.948*g/mole;
    Density= 1.4*g/cm3;
    Argon = new G4Material(Name,Z,A,Density);*/
//Dump materials
